    ...
    <main className="flex-1 md:ml-64 w-full max-w-[1440px] mx-auto p-margin-mobile md:p-margin-desktop overflow-x-hidden">
      ...
      <section className="mb-xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-gutter">
          {/* Course Card 1 */}
          <div className="glass-panel rounded-xl p-md flex flex-col sm:flex-row gap-md items-center glow-card relative overflow-hidden">
      ...
      <section className="mb-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-sm">
          <div className="glass-panel rounded-xl p-md md:col-span-2 lg:col-span-2 row-span-2 flex flex-col justify-end relative overflow-hidden group min-h-[300px]">
          ...
          <div className="glass-panel rounded-xl p-md flex flex-col justify-between glow-card relative group min-h-[140px]">
            <div className="flex justify-between items-start mb-2">
          ...
          <div className="glass-panel rounded-xl p-md flex flex-col items-center justify-center text-center glow-card border-primary/30 relative overflow-hidden min-h-[140px]">
          ...
          <div className="glass-panel rounded-xl p-md flex flex-col justify-between glow-card lg:col-span-2 min-h-[140px]">
